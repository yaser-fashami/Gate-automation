...
const patchBrowser = () => {
    ...
    const scriptElm = index.BUILD.scriptDataOpts || index.BUILD.safari10 || index.BUILD.dynamicImportShim
        ...
        : null;
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('traffic-light.cjs.js', document.baseURI).href));
...
patchBrowser().then(options => {
  ...
  return index.bootstrapLazy([["traffic-light.cjs",[[1,"traffic-light",{"currentState":[513,"current-state"],"color":[513],"mode":[513]}]]]], options);
});
