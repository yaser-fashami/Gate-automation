...
const TrafficLight = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    attachShadow(this);
  ...
  render() {
    return (h(Host, null, h("div", { class: "traffic-light" }, h("div", { class: "wrapper" }, this.mode === TrafficLightMode.SingleLight
  ...
  static get style() { return trafficLightCss; }
};

globalScripts();
const TrafficLight$1 = /*@__PURE__*/proxyCustomElement(TrafficLight, [1,"traffic-light",{"currentState":[513,"current-state"],"color":[513],"mode":[513]}]);
...
export { TrafficLight$1 as TrafficLight, defineCustomElements };
